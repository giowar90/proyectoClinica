<form action="./controlMedico?id=1" method="post">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" type="text" placeholder="Nombre" name="nom" required="">
                                                            </div><br/>
                                                        </td>
                                                        <td>&nbsp;&nbsp;&nbsp;</td>
                                                        <td >
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                                                                <input class="form-control" type="text" placeholder="Apellido paterno" name="appat" required="">
                                                            </div><br/>
                                                        </td>
                                                        <td>&nbsp;&nbsp;&nbsp;</td>
                                                        <td>
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                                                                <input class="form-control" type="text" placeholder="Apellido materno" name="apamat" required="">
                                                            </div><br/>
                                                        </td>
                                                    </tr>
                                                    <tr>
